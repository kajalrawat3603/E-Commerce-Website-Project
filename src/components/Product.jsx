...
const Product = () => {
  ...
  try {
    const response = await fetch(`https://e-commerce-website-project.onrender.com/products/${productId}`, {
      method: 'GET'
    });
    if (!response.ok) {
  ...
  const handleAddToCart = async () => {
    ...
    try {
        const response = await fetch('https://e-commerce-website-project.onrender.com/cart/add', {
            method: 'POST',
            headers: {
