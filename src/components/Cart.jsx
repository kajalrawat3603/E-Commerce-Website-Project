...
const Cart = () => {
  ...
  useEffect(() => {
    const fetchCart = async () => {
      try {
        const response = await fetch('https://e-commerce-website-project.onrender.com/cart', {
          method: 'GET',
          credentials: 'include',
          headers: {
  ...
  const handleRemove = async (productId, size) => {
    try {
      const response = await fetch('https://e-commerce-website-project.onrender.com/cart/remove', {
        method: 'POST',
        headers: {
  ...
  const handleQuantityChange = async (productId, size, newQuantity) => {
    ...
    try {
      const response = await fetch('https://e-commerce-website-project.onrender.com/cart/update', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${Cookies.get('jwtToken')}`
      ...
      <div className="container">
        ...
        <div className="site-footer" style={{ backgroundColor: 'white', height: 'fit-content', width: 'fit-content' }}>
          ...
          color: 'white'
              ...
              <tr style={{ backgroundColor: 'purple', color: 'lavenderblush' }}><td style={{ float: 'left' }}>Total</td><td>₹ {total}</td></tr>
            </tbody>
          </table>
